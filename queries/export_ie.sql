...
-- 
-- INSERT INTO mm (id, create_uid, create_date, write_date, write_uid, body, model, record_name, date, subject, message_id, parent_id, res_id, subtype_id, author_id, type, email_from) 
-- SELECT          id, create_uid, create_date, write_date, write_uid, body, model, record_name, date, subject, message_id, parent_id, res_id, subtype_id, author_id, type, email_from 
-- FROM mail_message; 
